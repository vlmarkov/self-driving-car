...
```
sudo bash -c "chmod g+rw /dev/gpiomem0 && source /opt/ros/jazzy/setup.bash && source install/local_setup.bash && ros2 run chasiss-control chasiss-control ./ros2-modules/chasiss-control/chassis_control.param.yaml"
```
