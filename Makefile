...
# To debug purpose on your laptop (NOT Raspberry Pi board) you can disable gpio write feature
...
lane-detection-raspberry-no-img:
	colcon build --packages-select lane-detection --cmake-args -DENABLE_TESTS=$(ENABLE_TESTS) -DENABLE_COMPILER_OPTIONS=$(ENABLE_COMPILER_OPTIONS) -DENABLE_LATEST_CPP_STANDARD=$(ENABLE_LATEST_CPP_STANDARD) -DENABLE_RASPBERRY_BUILD=ON -DENABLE_RASPBERRY_DEBUG_IMG=OFF
